...
export class BuildBotServer extends cdk.Stack {
  ...
  constructor(scope: cdk.App, id: string, props: BuildBotServerProps) {
    ...
    const buildBotServerTask = new ecs.TaskDefinition(
      this,
      "BuildBotServerTask",
      {
    ...
    const serverContainer = buildBotServerTask.addContainer("ServerContainer", {
      image: ecs.ContainerImage.fromRegistry(
        props.imageRepository.repositoryUri
      ),
    ...
    props.imageRepository.grantPull(
      buildBotService.taskDefinition.obtainExecutionRole()
    );
